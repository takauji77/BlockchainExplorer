		...
		return function (menuItems, config) {
			...
			return function (data, index) {
				...
				d3.selectAll('.d3-context-menu').data([1])
					...
					.append('button').attr('type','submit').attr('id', 'submit').attr('onclick',"createPoint()").html('Submit');
				...
				list.selectAll('input').data(menuItems.bind(element)(data, index)).enter()
					.append('input').attr("id","pointId").attr("value", ((d)=>utils.toFactory(d.title).bind(element)(data, index)))
